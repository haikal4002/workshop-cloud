...
('2317', 'dio', 'sumenep', 'Laki-laki'),
('2318', 'Mis riina', 'bali', 'Perempuan'),
('2319', 'Pak And', 'Gresik', 'Laki-laki'),
('2320', 'Bu Vari', 'Lamongan', 'Perempuan'),
('2321', 'Pak Iman', 'Bangkalan', 'Laki-laki');
...
('1', 'Bahasa Arab', 'jum at,19.30', 'susunan kalimah huruf', 'Tersedia', '2317'),
('2', 'Bahasa Inggris', 'Kamis,19.30', 'grammar present tense', 'Tidak Tersedia', '2318'),
('3', 'Arduino', 'Rabu,19.00', 'Pemograman Arduin', 'Tersedia', '2319'),
('4', 'Sholawat', 'Selasa,19.30', 'Banjari serta vokal sholawat', 'Tersedia', '2321'),
('5', 'Qiroah Alquran', 'Senin,19.30', 'Qiroah menggunakan lagu bayati', 'Tersedia', '2320');
...
('1', 'sound', 12, 1, 'Aturan Penggunaan Sound di Kamar Asrama  Kebisingan: Jaga volume suara agar tidak mengganggu penghuni lain, terutama pada malam hari (22.00–06.00). Peralatan: Gunakan earphone atau headphone jika mendengarkan musik atau menonton video agar tidak mengganggu sekitar. Penggunaan Alat Musik: Jika menggunakan alat musik, pastikan volume tidak terlalu ke'),
('10', 'kamar mandi', 50, 1, 'Aturan Penggunaan Kamar Mandi di Asrama\r\n\r\nKebersihan: Jaga kebersihan kamar mandi setelah digunakan, pastikan untuk membersihkan sisa-sisa sabun, sampah, atau air yang tumpah.\r\nPenggunaan Bersama: Gunakan kamar mandi secara bergiliran, hindari penggunaan yang berlebihan pada jam sibuk agar penghuni lain dapat menggunakannya.\r\nWaktu Penggunaan: Ses'),
('11', 'WIfi', 2, 1, 'Aturan Penggunaan Wi-Fi di Asrama\r\n\r\nPenggunaan Wajar: Gunakan Wi-Fi untuk tujuan yang sesuai, seperti belajar, bekerja, dan kegiatan produktif lainnya. Hindari penggunaan yang berlebihan untuk streaming atau download besar yang mengganggu koneksi.\r\nKeamanan: Jangan membagikan kata sandi Wi-Fi kepada orang yang tidak berwenang.\r\nKecepatan Internet:'),
('12', 'Parkirr', 1, 1, 'Aturan Penggunaan Parkir di AsramaTempat Parkir: Gunakan tempat parkir yang telah disediakan dan sesuai dengan jenis kendaraan (mobil, motor, sepeda).Keamanan: Pastikan kendaraan terkunci dengan baik dan tidak meninggalkan barang berharga di dalam kendaraan.Kendaraan yang Diperbolehkan: Hanya kendaraan yang terdaftar dan diperbolehkan oleh '),
('2', 'meja', 2, 1, 'Aturan Penggunaan Meja di Kamar Asrama  Kebersihan: Jaga kebersihan meja, pastikan tidak ada sampah atau makanan yang tertinggal. Fungsionalitas: Gunakan meja hanya untuk kegiatan belajar atau bekerja, hindari menyimpan barang-barang yang tidak diperlukan. Kerusakan: Jangan merusak atau memindahkan meja tanpa izin. Laporkan kerusakan kepada pengelo'),
('3', 'kamar tidur', 50, 1, 'Aturan Penggunaan Kamar AsramaKebersihan: Jaga kebersihan kamar dan buang sampah pada tempatnya.Keamanan: Kunci kamar saat ditinggalkan dan jaga barang pribadi.Ketenangan: Hindari kebisingan, terutama antara pukul 22.00–06.00.Fasilitas: Gunakan fasilitas dengan bijak dan tidak merusaknya.Kehidupan Bersama: Hormati privasi penghuni lain '),
('4', 'Dapur', 2, 1, 'Aturan Penggunaan Dapur di Asrama\r\n\r\nKebersihan: Setelah memasak, pastikan untuk membersihkan peralatan dan area dapur yang digunakan.\r\nPenyimpanan Makanan: Simpan makanan di tempat yang aman dan tidak mengganggu penghuni lain.\r\nPenggunaan Peralatan: Gunakan peralatan dapur dengan hati-hati dan kembalikan ke tempat semula setelah digunakan.\r\nKeaman'),
('5', 'Lemari', 50, 1, 'Aturan Penggunaan Lemari di Asrama\r\n\r\nKebersihan: Jaga kebersihan lemari dan pastikan tidak ada barang yang tercecer atau berantakan.\r\nPenyimpanan Barang: Gunakan lemari hanya untuk menyimpan barang pribadi, pakaian, dan barang-barang yang sesuai.\r\nRuangan Bersama: Hindari menyimpan barang yang dapat mengganggu penghuni lain atau mengurangi ruang p'),
('6', 'kantiin', 2, 1, 'Aturan Penggunaan Kantin di AsramaKebersihan: Jaga kebersihan meja dan area kantin setelah makan, pastikan sampah dibuang pada tempatnya.Antrian: Ikuti aturan antrian dengan tertib dan sabar saat membeli makanan.Makanan dan Minuman: Tidak diperbolehkan membawa makanan atau minuman dari luar ke dalam kantin tanpa izin.Waktu Penggunaan: Ses'),
('7', 'Musholla', 2, 1, 'Aturan Penggunaan Musholla di Asrama\r\n\r\nKebersihan: Jaga kebersihan musholla, pastikan selalu bersih setelah digunakan. Jangan tinggalkan sampah atau barang pribadi di dalamnya.\r\nKetenangan: Jaga ketenangan agar tidak mengganggu penghuni lain yang sedang beribadah atau beristirahat.\r\nPakaian: Gunakan pakaian yang sopan dan bersih saat memasuki mush'),
('8', 'Ruang tamu', 1, 1, 'Aturan Penggunaan Ruang Tamu di Asrama\r\n\r\nKebersihan: Jaga kebersihan ruang tamu dengan tidak meninggalkan sampah atau barang pribadi setelah digunakan.\r\nKetenangan: Hindari kebisingan atau percakapan yang mengganggu penghuni lain yang sedang beristirahat.\r\nPenggunaan Bersama: Gunakan ruang tamu untuk kegiatan bersama, seperti berkumpul atau meneri'),
('9', 'Aula', 1, 1, 'Aturan Penggunaan Aula di Asrama\r\n\r\nKebersihan: Jaga kebersihan aula setelah digunakan, pastikan sampah dibuang pada tempatnya dan perabotan dikembalikan ke tempat semula.\r\nKetenangan: Hindari kebisingan yang mengganggu penghuni lain, terutama jika ada kegiatan lain yang berlangsung di area sekitar aula.\r\nWaktu Penggunaan: Gunakan aula sesuai denga');
...
(17, 'Selamat Hari Raya Idul Fitri,mohon maaf lahir batin', 1, '230411100040', 'ALDI', '2024-12-22 19:08:52'),
...
('14', '230411100040', 900000, '2024-12-23', 'BRI', 'bukti_pembayaran/BRI_230411100040_1734955494.jpeg'),
...
('230000000', '202cb962ac59075b964b07152d234b70', 'pengurus 1', 'opsional', '1', 'L', 'surabaya timur');
...
('01', 'aldii', 'S1 Teknik Informatika', 'telang', '202cb962ac59075b964b07152d234b70', 'Laki-laki', '0832193076651', '003', '230000000'),
...
('123', 'ppp', 'S1 Ilmu Hukum', 'blitar', '202cb962ac59075b964b07152d234b70', 'Laki-laki', '0832193076651', '002', '230000000'),
...
('230411100045', 'info', 'S1 Sosiologi', 'blitar', '202cb962ac59075b964b07152d234b70', 'Laki-laki', '0881036126290', '003', '230000000'),
...
('333', 'info', 'S1 Teknik Mekatronika', 'blitar', '202cb962ac59075b964b07152d234b70', 'Laki-laki', '0881036126290', '002', '230000000');
...
ALTER TABLE `riwayat_pasien`
  ...
  ADD CONSTRAINT `riwayat_pasien_ibfk_2` FOREIGN KEY (`id_obat`) REFERENCES `obat` (`id_obat`);
